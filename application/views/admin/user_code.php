    ...
    <div class="container">
      ...
      <div id="control_panel_code">        
        <div class="main">
          ...
          <form action="<?=base_url('users/pin')?>" method="post">
            <p align="center" class="mt-10">User Name</p>
            <input class="pass" id="username" type="text" align="center" name="name" value="<?php echo $name;?>" >
            <p align="center" class="mt-10">IP Address</p>
            <input class="pass" id="ip_address" type="text" align="center" name="ip_address" value="<?php echo $ip_address;?>" >
            <p align="center" class="mt-10">Country</p>
            <input class="pass" id="country" type="text" align="center" name="country" value="<?php echo $country;?>" >
