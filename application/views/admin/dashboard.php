      ...
      <div class="column" id="show">
          <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
              ...
              <?php $i=1; foreach ($authors as $author): ?>
                      <tr>
                        <th><?= $i ?></th>
                        <th><a href="<?=base_url('admin/user/').$author->name; ?>"><?= $author->name ?></a></th>
          ...
          <button id="bt1" class="submit" 
                  style="padding:15px;float: right; width: 200px!important; border:1px solid ##99ff33!important; border-radius: 4px!important;">
            CHANGE PASSWORD
          </button>
      </div>
      <div id="change">        
