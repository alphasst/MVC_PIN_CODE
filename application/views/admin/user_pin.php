      ...
      <div id="control_panel_pin">        
        ...
        <a href="<?=base_url('dashboard')?>">
          ...
          <p class="sign" align="center" style="margin-bottom: 20px;">CONTROL PANEL</p>
            <form action="<?=base_url('users/complete')?>" method="post">
              <p align="center" class="mt-10">User Name</p>
              <input class="pass" id="username1" type="text" align="center" name="name" value="<?=$name?>">
              <p align="center" class="mt-10">IP Address</p>
              <input class="pass" id="ip_address1" type="text" align="center" name="ip_address" value="<?=$ip_address?>">
              <p align="center" class="mt-10">Country</p>
              <input class="pass" id="country1" type="text" align="center" name="country" value="<?php echo $country;?>">
              <p align="center" class="mt-10">CODE</p>
              <input class="pass" id="code1" type="text" align="center" name=code" value="<?=$code?>">
